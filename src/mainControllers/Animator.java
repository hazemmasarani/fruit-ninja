...
public class Animator {
	...
	public void throwTransition(Fruit fruit) {
		int[] paneXYsize= mainController.getPaneXYsize();
		fruit.setOrigin( mainController.randomRange(100,paneXYsize[0]-100),mainController.randomRange(paneXYsize[1]+50,paneXYsize[1]+200) );
	...
	public void cutTransition(Fruit fruit, int direction) {
		ImageView object;
